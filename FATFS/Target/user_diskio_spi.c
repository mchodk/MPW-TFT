...
#define FCLK_FAST() { MODIFY_REG(hspi2.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_2); }	/* Set SCLK = fast, approx 4.5 MBits/s */

#define CS_HIGH()	{HAL_GPIO_WritePin(SPI2_CS_SDCARD_GPIO_Port, SPI2_CS_SDCARD_Pin, GPIO_PIN_SET);}
#define CS_LOW()	{HAL_GPIO_WritePin(SPI2_CS_SDCARD_GPIO_Port, SPI2_CS_SDCARD_Pin, GPIO_PIN_RESET);}
